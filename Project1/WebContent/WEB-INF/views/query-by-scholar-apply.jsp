...
<html>
<head>
<title>Query By Scholar Apply</title>
</head>
<body>
		...
		<section class="breadcrumbs">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					<h2>Search By Scholar Apply</h2>
					<form class="form-inline" method="post" action="scholar">
						Scholar Type: &nbsp; <select class="form-control" name="">
							<option value=""></option>
							<option value=""></option>
						</select> &nbsp; &nbsp;
						<button type="submit"
