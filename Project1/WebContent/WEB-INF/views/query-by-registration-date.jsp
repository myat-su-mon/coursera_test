...
<html>
<head>
<title>Query By Registration Date</title>
</head>
<body>
		...
		<section class="breadcrumbs">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					...
					<form class="form-inline" method="post" action="regdate">
						Registration Date between &nbsp; <input type="date" name="start"
							class="form-control" id="datepicker">&nbsp; and &nbsp; <input
							type="date" name="end" class="form-control" id="datepicker">
						&nbsp; &nbsp;
						<button type="submit"
