...
<html>
<head>
<title>Query By State Region</title>
</head>
<body>
		...
		<section class="breadcrumbs">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					<h2>Search By State Region</h2>
					<form class="form-inline" method="post" action="stateregion">
						State Region : &nbsp; <select class="form-control" name="stateregion">
							<option value="none"></option>
							<c:forEach var="s" items="${stateregions}">
			...
			<div class="container">
				...
				<div class="row counters">
					...
					<div class="col-lg-3 col-6 text-center">
						<span data-toggle="counter-up">${stateregions.size()}</span>
						<p>Townships</p>
					</div>
