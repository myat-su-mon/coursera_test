...
<body>
	...
	<main id="main">
		<section class="about" data-aos="fade-up">
			<div class="container">
				<form action="coresubupdate" method="post">
					...
					<div class="row">
						<div class="col-lg-6">
							<table>
								...
								<tr>
									<td>Semester</td>
									<td><select class="form-control" id="spacing"
											>
					...
					<div class="text-center">
						<button class="button" type="submit">Add Major Subject</button>
					</div>
				</form>
			</div>
		</section>
